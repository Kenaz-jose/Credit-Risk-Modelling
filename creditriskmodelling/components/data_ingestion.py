...
from creditriskmodelling.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Existed split_data_as_train__test method of Data_Ingestion class")
            ...
            logging.info("Exported train file path")
            ...
            logging.info("Exported test file path")
